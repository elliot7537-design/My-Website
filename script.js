...
const translations = {
  en: {
    ...
    'p2.tags': 'VETERINARY · HEALTH',
    'p2.body': 'The care your pet deserves. A Tijuana vet clinic site with appointment booking, doctor profiles, and bilingual services.',
    'p2.chips': 'WEB DESIGN|UX/UI|BILINGUAL',
    'p3.tags': 'RESTAURANT · DINING',
    'p3.body': 'Tradition meets fire. A dark, elegant site for a Mexican fire-cooked restaurant with menu, reservations, and brand identity.',
    'p3.chips': 'BRANDING|WEB DESIGN|MENU',
  ...
  es: {
    ...
    'p2.tags': 'VETERINARIA · SALUD',
    'p2.body': 'La salud que tu mascota merece. Sitio para una clínica veterinaria en Tijuana con reserva de citas, perfiles de doctores y servicios bilingües.',
    'p2.chips': 'DISEÑO WEB|UX/UI|BILINGÜE',
    'p3.tags': 'RESTAURANTE · GASTRONOMÍA',
    'p3.body': 'Tradición que se encuentra con el fuego. Sitio para un restaurante de cocina mexicana al fuego, con menú, reservas y una identidad oscura y elegante.',
    'p3.chips': 'BRANDING|DISEÑO WEB|MENÚ',
