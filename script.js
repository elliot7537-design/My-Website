...
const translations = {
  en: {
    ...
    'project.viewCase': 'VIEW LIVE SITE →',
    'p1.tags': 'CAFÉ · ART',
    'p1.body': 'Where coffee feeds and art awakens. Identity and digital experience for a Mexican café that blends specialty beans with an art gallery.',
    'p1.chips': 'BRANDING|WEB DESIGN|ART',
    'p2.tags': 'CAFÉ · BRAND',
    'p2.body': 'Where coffee meets craft. A specialty coffee brand site with single-origin sourcing, artisan roasting, and a warm modern identity.',
    'p2.chips': 'BRANDING|WEB DESIGN|E-COMMERCE',
    'p3.tags': 'VETERINARY · HEALTH',
    'p3.body': 'The care your pet deserves. A Tijuana vet clinic site with appointment booking, doctor profiles, and bilingual services.',
    'p3.chips': 'WEB DESIGN|UX/UI|BILINGUAL',
    'p4.tags': 'RESTAURANT · DINING',
    'p4.body': 'Tradition meets fire. A dark, elegant site for a Mexican fire-cooked restaurant with menu, reservations, and brand identity.',
    'p4.chips': 'BRANDING|WEB DESIGN|MENU',
  ...
  es: {
    ...
    'project.viewCase': 'VER SITIO EN VIVO →',
    'p1.tags': 'CAFETERÍA · ARTE',
    'p1.body': 'Un espacio donde el café alimenta y el arte despierta. Identidad y experiencia digital para una cafetería mexicana que mezcla granos de especialidad con galería de arte.',
    'p1.chips': 'BRANDING|DISEÑO WEB|ARTE',
    'p2.tags': 'CAFETERÍA · MARCA',
    'p2.body': 'Donde el café se encuentra con el oficio. Sitio para una marca de café de especialidad con origen único, tostado artesanal y una identidad cálida y moderna.',
    'p2.chips': 'BRANDING|DISEÑO WEB|E-COMMERCE',
    'p3.tags': 'VETERINARIA · SALUD',
    'p3.body': 'La salud que tu mascota merece. Sitio para una clínica veterinaria en Tijuana con reserva de citas, perfiles de doctores y servicios bilingües.',
    'p3.chips': 'DISEÑO WEB|UX/UI|BILINGÜE',
    'p4.tags': 'RESTAURANTE · GASTRONOMÍA',
    'p4.body': 'Tradición que se encuentra con el fuego. Sitio para un restaurante de cocina mexicana al fuego, con menú, reservas y una identidad oscura y elegante.',
    'p4.chips': 'BRANDING|DISEÑO WEB|MENÚ',
